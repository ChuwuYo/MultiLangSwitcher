...
const translate = (key, params = {}) => (DetectPageContext.translate ? DetectPageContext.translate(key, params) : key);

const getUiLanguage = () => (DetectPageContext.getUiLanguage() === "zh" ? "zh" : "en");
