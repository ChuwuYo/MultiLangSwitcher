<div align="center">
    <img src="assets/images/icon256.png" alt="MultiLangSwitcher Icon" width="150" height="150"> <h1>MultiLangSwitcher</h1>
...
If the built-in request header detection fails or returns no results, you can manually navigate to [BrowserScan](https://www.browserscan.net) or [Pixelscan](https://pixelscan.net/fingerprint-check) for further verification.
...
* Exported Markdown only contains visible conversation; for detection data, please select 'Export Structured Text'
